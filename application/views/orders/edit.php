            ...
            <div class="box-body">
              ...
              <div class="col-md-6 col-xs-12 pull pull-right">
                ...
                <?php if ($is_service_enabled == true) : ?>
                  <div class="form-group">
                    <label for="service_charge" class="col-sm-5 control-label">SGST <?php echo $company_data['service_charge_value'] ?> %</label>
                    <div class="col-sm-7">
                ...
                <?php if ($is_vat_enabled == true) : ?>
                  <div class="form-group">
                    <label for="vat_charge" class="col-sm-5 control-label">CGST <?php echo $company_data['vat_charge_value'] ?> %</label>
                    <div class="col-sm-7">
...
<script type="text/javascript">
  ...
  //         // mywindow.document.write('<link rel="stylesheet" href="<?php 
                                                                      ?>" type="text/css" />');
    ...
    if (product_id == "") {
      ...
      $.ajax({
        ...
        success: function(response) {
          ...
          // Apply the profit percent on rate
          var profit_on_rate = (response.price * profit) / 100;
          var final_totalRate = Number(response.price) + profit_on_rate;

          $("#rate_" + row_id).val(final_totalRate);
          $("#rate_value_" + row_id).val(final_totalRate);

          $("#qty_" + row_id).val(1);
          $("#qty_value_" + row_id).val(1);

          var total = Number(final_totalRate) * 1;
          total = total.toFixed(2);
  ...
  function subAmount() {
    ...
    var profit = <?php echo ($company_data['profit'] > 0) ? $company_data['profit'] : 0; ?>;
    ...
    // Apply the profit percent on gross amount
    var profit_on_total_amount = (totalSubAmount * profit) / 100;
    final_totalSubAmount = totalSubAmount + profit_on_total_amount;
    totalSubAmount = final_totalSubAmount.toFixed(2);
